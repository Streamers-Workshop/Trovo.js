...
const TrovoApollo = require('./TrovoApollo')
const protobuf = require("protobufjs")
const Pbf = require('pbf')

const DATA_ENUMS = require('./enums.js')
...
function decodePacket (data) {
  ...
  let size = dv.getInt32(0)
  if (size !== dv.byteLength) { return }
  let operation = dv.getInt16(8)
  return {
    seq: dv.getInt32(10),
    operation,
    body: {
