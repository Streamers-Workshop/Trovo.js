...
module.exports = class Client extends EventEmitter {
    ...
    async subs() {
        ...
        var click_subs =
            "#__layout > div > div > div.page-container.base-main > div > div:nth-child(2)";
        ...
        if (email && email.length > 0) {
            ...
            try {
                ...
                await this.page.waitForSelector(
                    "div > div > div:nth-child(3) > div > section.buttons > button.cat-button.button.normal.primary"
                );
    ...
    */
            ...
            const closePath =
                "svg.svg-icon.cursor-pointer.toggle-icon.hover-highlight";
        ...
        if (op.chatType !== undefined) {
            ...
            switch (op.chatType) {
                ...
                case DATA_ENUMS.CHAT_TYPES.GIFT: // Gift
                    ...
                    const newdata = {
                        ...spelldata,
                        ...DATA_ENUMS.SPELL_DATA[spellenum]
                    };
                    op.content = newdata;
