...
module.exports = class Client extends EventEmitter {
  ...
  async login(url, email, password, cookies) {
    ...
    //if cookies.length is 0, cookies.json wasnt loaded and you need to log into trovo
...
//allows you to pass in a file name and get the cookies to the page. writes the cookies as a JSON stringified object to a new cookies.json file to be loaded later	
...
//loads the cookies from the cookies.json file that is passed in. switch website to google, load cookies, jump back to trovo channel
